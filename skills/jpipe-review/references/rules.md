...
| S03 | accidental-unification | **language** | Identical labels denote **different** artifacts, and they *will* merge into a claim nobody wrote | Disambiguate the labels (`unifyExclude` only as a workaround) | 🔴 |
